 ...
 * https://github.com/matomo-org/matomo/blob/3.14.1/core/ReportRenderer/Pdf.php
 * 
 * 
 ...
 * PDF report renderer
 */
class CustomPdfRenderer extends ReportRenderer
{
    ...
    const FRONTPAGE_TEXT_COLOR = "255,255,255";
    ...
    public function renderFrontPage($reportTitle, $prettyDate, $description, $reportMetadata, $segment)
    {
        ...
        $frontPageTextColor = preg_split("/,/", static::FRONTPAGE_TEXT_COLOR);
        ...
        $this->TCPDF->Ln(80);
        $this->TCPDF->Cell(0, 0, "Web Analytics Italia");
        ...
        $this->TCPDF->SetTextColor($frontPageTextColor[0], $frontPageTextColor[1], $frontPageTextColor[2]);
        $this->TCPDF->Cell(0, 0, $dateRange, 0);
        $this->TCPDF->Ln(20);
